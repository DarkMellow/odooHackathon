...
function formatProfileToAuthUser(apiProfile: any): AuthUser {
  return {
    ...
    profile: {
      ...
      loveAboutJob: apiProfile.loveAboutJob,
      interestsHobbies: apiProfile.interestsHobbies,
      skills: apiProfile.skills,
      certs: apiProfile.certs,
      nationality: apiProfile.nationality,
      personalEmail: apiProfile.personalEmail,
      gender: apiProfile.gender,
      maritalStatus: apiProfile.maritalStatus,
      bankAccount: apiProfile.bankAccount,
      bankName: apiProfile.bankName,
      ifscCode: apiProfile.ifscCode,
      panNo: apiProfile.panNo,
      uanNo: apiProfile.uanNo,
    },
  };
}
